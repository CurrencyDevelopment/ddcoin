...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in DDCoin
...
bool CBlock::CheckBlock(bool fCheckPOW, bool fCheckMerkleRoot, bool fCheckSig) const
{
    ...
    if (fProofOfStake)
    {
        ...
        // DDCoin: check proof-of-stake block signature
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "DDCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        unsigned int nTimeGenesis = fTestNet ? 1475222468 : 1475222768;

        unsigned int nNonceGenesis = fTestNet ? 70761 : 1709326;

        const char* pszTimestamp = "DDC Genesis Block";
        CTransaction txNew;
        ...
        //// debug print
       if(fTestNet){
         assert(block.hashMerkleRoot == uint256("0xb66f1f370a7afa237a7aec21fa7c94a272c9a85dda95da06b42261abbd9e5cbc"));
       }
       else {
         assert(block.hashMerkleRoot == uint256("0xbf5699b6d7a27ac2d086af985ccd00a65ed8ef68322e1b424f8b8b57a8539199"));
       }
...
unsigned char pchMessageStart[4] = { 0xe3, 0xe1, 0xe9, 0xb9 };
